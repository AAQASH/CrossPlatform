...
include_once('../bootstrap.php');
	...
	try{
		if($edit_id > 0){
			$contentStmt = $db->query('select * from mts_contentpage where contentpage_id=?', $edit_id);
			$data = $contentStmt->fetch();
			if(count($data) > 0){
				extract($data);
				unset($data);
			}
...
<div id="maincont" class="ovfl-hidden">
  <div class="box">
    <div class="heading">
      <div class="mainhead">
        <h3 class="fl">Save Content Page </h3>
        <div class="fr">
          <input type="button" class="btn btn-primary btn-xs" name="btnback" id="btnback" value=" Back " onClick="javascript:location.href='content-page-list.php';" />
        </div>
        <div class="clr"></div>
      </div>
    </div>
        ...
        <div>
          <div class="">
            <table width="100%" class="form">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input type="checkbox" name="chkAllowComments"  value="1" id="chkAllowComments" <?php echo ((int)$is_allow_comment > 0 ? 'checked="checked"' : ''); ?>/>
                  &nbsp;&nbsp;
                  <label for="chkAllowComments">Allow Comments</label></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td valign="top">Template: </td>
                <td colspan="2" valign="top"><select class="form-control" name="page_template_id" id="page_template_id>">
              ...
              <tr>
                ...
                <td colspan="2" valign="top"><textarea cols="80" id="description" name="description" rows="10"><?php echo $description?></textarea>
		    ...
		    <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input type="submit" name="btnsubmit" id="btnsubmit" value=" Save Content Page Information " class="btn btn-primary" /></td>
                <td>&nbsp;</td>
              </tr>
            </table>
          </div>
