...
include_once(dirname(dirname(dirname(__FILE__))).'/includes/SiteConfig.php');
$baseUrl = SITEROOT . '/uploads/fck/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = dirname(dirname(dirname(__FILE__))).'/uploads/fck/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3,pdf',
		'deniedExtensions' => '');
